...
import { FaEnvelope, FaSchool, FaUser, FaRegEdit, FaComments } from "react-icons/fa";
...
const ContactUs = () => {
  ...
  return (
    <>
    <Navbar />
    <div className="bg-raisin-black-2 min-h-screen text-white py-10 px-4 md:px-20 lg:px-40">
      <h2 className="text-3xl font-bold text-buff-500 text-center mb-6">Contact Us</h2>
